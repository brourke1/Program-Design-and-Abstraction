...
public class ArrayPracticeTest {
	...
	public void testIsOdd() {
		assertTrue(ArrayPractice.isOdd(1));
		assertFalse(ArrayPractice.isOdd(2));
		assertTrue(ArrayPractice.isOdd(5));
		assertFalse(ArrayPractice.isOdd(10));
		assertTrue(ArrayPractice.isOdd(7543));
		assertFalse(ArrayPractice.isOdd(68));
	}
	 ...
	 */
	 ...
	 public void testGetCol() {
       ...
       assertArrayEquals(ArrayPractice.getCol(A, 0), B);
       assertArrayEquals(ArrayPractice.getCol(A, 1), C);
       assertArrayEquals(ArrayPractice.getCol(A, 2), D);
	 }
}
