...
class StringPracticeTest extends StringPractice {
  ...
  void testNumPunctAfterNonPunct() {
    assertEquals(0, StringPractice.numPunctAfterNonPunct(""));
    assertEquals(1, StringPractice.numPunctAfterNonPunct("a!"));
    assertEquals(2, StringPractice.numPunctAfterNonPunct("ap!ple!s"));
    assertEquals(1, StringPractice.numPunctAfterNonPunct("bananas!"));
    assertEquals(3, StringPractice.numPunctAfterNonPunct("b!!b!s!"));
    assertEquals(2, StringPractice.numPunctAfterNonPunct("1.' a'"));
    assertEquals(5, StringPractice.numPunctAfterNonPunct("a.b'c!d?e,"));
